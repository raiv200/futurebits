...
export const GlareCard = ({
  ...
  return (
    (<div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[z(--easing)] delay-[var(--delay)] will-change-transform "
      ref={refElement}
      onPointerMove={(event) => {
