...
import { AnimatedBorderButton } from "../animated-button";
...
const NavLink = React.forwardRef(({ href, children, className, isActive }, ref) => (
  <Link
    href={href}
    ref={ref}
    ...
    >
      <div className="flex flex-col gap-10 mt-20 ">
        ...
        <div className="w-full px-6 sm:px-12">
          {/* <button
            className={`relative min-w-[250px] flex items-center rounded-full justify-center font-medium text-[12px] sm:text-[18px] overflow-hidden px-[14px] h-[40px] sm:px-[20px] sm:h-[45px] text-white bg-[#2E2688]`}
          >
            Book a call
    ...
    <nav className="w-full lg:max-w-[950px] xl:min-w-[1100px] z-10 mx-auto rounded-b-[32px]">
      ...
      >
        ...
        <div className="flex w-full justify-between items-center">
          ...
          {/* <button
            className={`relative flex items-center rounded-full justify-center font-medium text-[12px] sm:text-[18px] overflow-hidden px-[14px] h-[40px] sm:px-[20px] sm:h-[45px] text-white bg-[#2E2688]`}
          >
            Book a call
            <ChevronRightIcon strokeWidth={3} className="h-4 w-4 ml-1" />
            <BorderBeam
